...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-introduction" data-rule="required" class="form-control" name="row[introduction]" type="text" value="<?php echo $row['introduction']; ?>">
        </div>
    </div>
